...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Apr 2018 pada 00.47
...
--
-- Dumping data untuk tabel `tbmotor`
--

INSERT INTO `tbmotor` (`TIPE_MODEL`, `ID_KTG`, `ID_SUPPLIER`, `NOMOR_RANGKA`, `NOMOR_MESIN`, `NAMA_MOTOR`, `HARGA_MOTOR`, `STOK_MOTOR`) VALUES
('1', '1', '1', '35679877FF', '35679877FF', 'Honda Beat', 16000000, 310);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbmotor_keluar`
--
...
--
-- Dumping data untuk tabel `tbmotor_keluar`
--
...
--
-- Struktur dari tabel `tbmotor_masuk`
--
...
--
-- Dumping data untuk tabel `tbmotor_masuk`
--
...
--
-- Struktur dari tabel `tborder_motor`
--
...
--
-- Dumping data untuk tabel `tborder_motor`
--
...
--
-- Struktur dari tabel `tborder_sparepart`
--
...
--
-- Dumping data untuk tabel `tborder_sparepart`
--
...
('2', '1', 'ID002', '2018-01-11', 12);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbretur_pembelian_motor`
--
...
--
-- Dumping data untuk tabel `tbretur_pembelian_motor`
--

INSERT INTO `tbretur_pembelian_motor` (`NO_RETUR_PEMBELIAN_MOTOR`, `ID_USER`, `TIPE_MODEL`, `TGL_RETUR_PEMBELIAN_MOTOR`, `JML_RETUR_PEMBELIAN_MOTOR`, `STATUS_RETUR_PEMBELIAN_MOTOR`) VALUES
(1, 'ID002', '1', '2018-01-12', 13, 'rusak');

--
-- Trigger `tbretur_pembelian_motor`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tbretur_pembelian_sparepart`
--
...
--
-- Dumping data untuk tabel `tbretur_pembelian_sparepart`
--
...
(2, 'ID001', '1', '2018-01-11', 3, 'aaa'),
(3, 'ID002', '1', '2018-01-01', 10, 'rusak');

--
-- Trigger `tbretur_pembelian_sparepart`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tbretur_penjualan_motor`
--
...
--
-- Dumping data untuk tabel `tbretur_penjualan_motor`
--

INSERT INTO `tbretur_penjualan_motor` (`NO_RETUR_PENJUALAN_MOTOR`, `ID_USER`, `TIPE_MODEL`, `TGL_RETUR_PENJUALAN_MOTOR`, `JML_RETUR_PENJUALAN_MOTOR`, `STATUS_RETUR_PENJUALAN_MOTOR`) VALUES
(1, 'ID001', '1', '2018-01-11', 3, 'Q'),
(2, 'ID002', '1', '2018-01-11', 160, 'fs'),
(3, 'ID002', '1', '2018-01-12', 5, 'kembali');

--
-- Trigger `tbretur_penjualan_motor`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tbretur_penjualan_sparepart`
--
...
--
-- Dumping data untuk tabel `tbretur_penjualan_sparepart`
--

INSERT INTO `tbretur_penjualan_sparepart` (`NO_RETUR_PENJUALAN`, `ID_USER`, `NOMOR_SERI`, `TGL_RETUR_PENJUALAN_SPAREPART`, `JML_RETUR_PENJUALAN`, `STATUS_RETUR_PENJUALAN`) VALUES
(1, 'ID001', '1', '2018-01-11', 5, 'aaa'),
(2, 'ID001', '1', '2018-01-11', 5, 'aaa'),
(3, 'ID001', '1', '2018-01-11', 5, 'rusak'),
(4, 'ID002', '1', '2018-01-11', 5, 'rusak'),
(5, 'ID002', '1', '2018-01-11', 10, 'kembali'),
(6, 'ID002', '1', '2018-01-01', 5, 'kembali'),
(7, 'ID002', '1', '2018-01-01', 10, 'kembali');

--
-- Trigger `tbretur_penjualan_sparepart`
--
DELIMITER $$
...
--
-- Struktur dari tabel `tbsparepart_keluar`
--
...
--
-- Struktur dari tabel `tbsparepart_masuk`
--
...
--
-- Dumping data untuk tabel `tbsparepart_masuk`
--
...
--
-- Ketidakleluasaan untuk tabel `tbmotor`
--
ALTER TABLE `tbmotor`
...
--
-- Ketidakleluasaan untuk tabel `tbmotor_keluar`
--
ALTER TABLE `tbmotor_keluar`
...
--
-- Ketidakleluasaan untuk tabel `tbmotor_masuk`
--
ALTER TABLE `tbmotor_masuk`
...
--
-- Ketidakleluasaan untuk tabel `tborder_motor`
--
ALTER TABLE `tborder_motor`
...
--
-- Ketidakleluasaan untuk tabel `tborder_sparepart`
--
ALTER TABLE `tborder_sparepart`
...
--
-- Ketidakleluasaan untuk tabel `tbretur_pembelian_motor`
--
ALTER TABLE `tbretur_pembelian_motor`
...
--
-- Ketidakleluasaan untuk tabel `tbretur_pembelian_sparepart`
--
ALTER TABLE `tbretur_pembelian_sparepart`
...
--
-- Ketidakleluasaan untuk tabel `tbretur_penjualan_motor`
--
ALTER TABLE `tbretur_penjualan_motor`
...
--
-- Ketidakleluasaan untuk tabel `tbretur_penjualan_sparepart`
--
ALTER TABLE `tbretur_penjualan_sparepart`
...
--
-- Ketidakleluasaan untuk tabel `tbsparepart`
--
ALTER TABLE `tbsparepart`
...
--
-- Ketidakleluasaan untuk tabel `tbsparepart_keluar`
--
ALTER TABLE `tbsparepart_keluar`
...
--
-- Ketidakleluasaan untuk tabel `tbsparepart_masuk`
--
ALTER TABLE `tbsparepart_masuk`
